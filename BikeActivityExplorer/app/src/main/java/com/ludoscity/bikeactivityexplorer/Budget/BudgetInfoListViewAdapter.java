package com.ludoscity.bikeactivityexplorer.Budget;
...
public class BudgetInfoListViewAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = mInflater.inflate(com.ludoscity.bikeactivityexplorer.R.layout.budgetinfolist_item, null);
            holder.sortCriteriaLine1 = (TextView) convertView.findViewById(com.ludoscity.bikeactivityexplorer.R.id.budgetinfoitem_sort_criteria_line1);
            holder.sortCriteriaLine2 = (TextView) convertView.findViewById(com.ludoscity.bikeactivityexplorer.R.id.budgetinfoitem_sort_criteria_line2);
            holder.startStationName = (TextView) convertView.findViewById(com.ludoscity.bikeactivityexplorer.R.id.budgetinfoitem_start_station_name);
            holder.endStationName = (TextView) convertView.findViewById(com.ludoscity.bikeactivityexplorer.R.id.budgetinfoitem_end_station_name);
            holder.additionalInfoLine1 = (TextView) convertView.findViewById(com.ludoscity.bikeactivityexplorer.R.id.budgetinfoitem_info_line1);
            holder.additionalInfoLine2 = (TextView) convertView.findViewById(com.ludoscity.bikeactivityexplorer.R.id.budgetinfoitem_info_line2);
