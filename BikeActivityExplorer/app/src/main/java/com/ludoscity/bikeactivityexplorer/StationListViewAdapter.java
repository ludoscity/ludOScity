...
public class StationListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = mInflater.inflate(com.ludoscity.bikeactivityexplorer.R.layout.stationlist_item, null);
            holder.distance = (TextView) convertView.findViewById(com.ludoscity.bikeactivityexplorer.R.id.station_distance);
            holder.name = (TextView) convertView.findViewById(com.ludoscity.bikeactivityexplorer.R.id.station_name);
            holder.availability = (TextView) convertView.findViewById(com.ludoscity.bikeactivityexplorer.R.id.station_availability);
