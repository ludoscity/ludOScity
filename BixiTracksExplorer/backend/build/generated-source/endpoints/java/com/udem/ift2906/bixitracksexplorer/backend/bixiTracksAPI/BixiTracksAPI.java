...
package com.udem.ift2906.bixitracksexplorer.backend.bixiTracksAPI;

/**
 * Service definition for BixiTracksAPI (v1).
 *
 * <p>
 * This is an API
 * </p>
 ...
 *
 * <p>
 * This service uses {@link BixiTracksAPIRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 * </p>
 *
 * @since 1.3
...
public class BixiTracksAPI extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.19.1 of the bixiTracksAPI library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "bixiTracksAPI/v1/";
   ...
   * @since 1.7
   */
  public BixiTracksAPI(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
   ...
   *
   * This request holds the parameters needed by the bixiTracksAPI server.  After setting any optional
   * parameters, call the {@link GetTrack#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public GetTrack getTrack() throws java.io.IOException {
    GetTrack result = new GetTrack();
    initialize(result);
    return result;
  }

  public class GetTrack extends BixiTracksAPIRequest<com.udem.ift2906.bixitracksexplorer.backend.bixiTracksAPI.model.Track> {
     ...
     * Create a request for the method "getTrack".
     *
     * This request holds the parameters needed by the the bixiTracksAPI server.  After setting any
     ...
     */
    protected GetTrack() {
      super(BixiTracksAPI.this, "GET", REST_PATH, null, com.udem.ift2906.bixitracksexplorer.backend.bixiTracksAPI.model.Track.class);
    }
  ...
  public class SayHi extends BixiTracksAPIRequest<com.udem.ift2906.bixitracksexplorer.backend.bixiTracksAPI.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(BixiTracksAPI.this, "POST", REST_PATH, null, com.udem.ift2906.bixitracksexplorer.backend.bixiTracksAPI.model.MyBean.class);
  ...
  /**
   * Builder for {@link BixiTracksAPI}.
   *
   * <p>
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    /** Builds a new instance of {@link BixiTracksAPI}. */
    @Override
    public BixiTracksAPI build() {
      return new BixiTracksAPI(this);
    }
    ...
    /**
     * Set the {@link BixiTracksAPIRequestInitializer}.
     *
     * @since 1.12
     */
    public Builder setBixiTracksAPIRequestInitializer(
        BixiTracksAPIRequestInitializer bixitracksapiRequestInitializer) {
      return (Builder) super.setGoogleClientRequestInitializer(bixitracksapiRequestInitializer);
    }
